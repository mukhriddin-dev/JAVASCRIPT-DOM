...
function searchProduct(searchTerm) {
    const searchReslut = product.products.filter((el) => el.title.toLowerCase().includes(searchTerm.toLowerCase()) || el.description.toLowerCase().includes(searchTerm.toLowerCase()))
